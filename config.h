...
static const char *fonts[]          = { "Hack:size=13","FontAwesome:size=15","NotoColorEmoji:pixelsize=17:antialias=true:autohint=true" };
...
static Key keys[] = {
	...
	{ MODKEY,			XK_Down,   spawn,	   	  SHCMD("sound_down")  },
	{ MODKEY, 			XK_Up,   spawn,	  SHCMD("sound_up") },
